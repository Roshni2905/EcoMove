...
public class UserAppGUI {
    ...
    public UserAppGUI() {
        ...
        frame = new JFrame("Eco Ride Share App");
    ...
    private void createRegisterPanel() {
        ...
        JLabel regLocationLabel = new JLabel("Route :");
        regLocationField = new JTextField();
        JLabel regSkillsLabel = new JLabel("Vehicle (NA, if None) :");
    ...
    private void createHomePanel() {
        ...
        JLabel locationLabel = new JLabel("Filter by Route :");
        JComboBox<String> locationFilterComboBox = new JComboBox<>(getLocations());
        JLabel skillsLabel = new JLabel("Filter by Vehicles :");
    ...
    private void applyFilters(String location, String skills) {
        ...
        for (Map.Entry<String, String[]> entry : users.entrySet()) {
            ...
            if ((location.equals("All") || userLocation.equals(location)) &&
                ...
                JLabel usernameLabel = new JLabel("Username: " + username);
                JLabel locationLabel = new JLabel("Route : " + userLocation);
                JLabel skillsLabel = new JLabel("Vehicle : " + userSkills);
